...
const Contacto = () => {
    ...
    return (
        <>
            <SEO 
                title="Contacto"
                description="Contactanos para cualquier consulta. Estamos aquí para ayudarte con tus compras y resolver todas tus dudas."
                keywords="contacto, ayuda, soporte, consultas, atención al cliente"
                url="https://react25017-diegomaggio.netlify.app/contacto"
            />
